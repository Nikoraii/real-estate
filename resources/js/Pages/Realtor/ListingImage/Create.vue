  ...
  <Box>
    ...
    <form @submit.prevent="upload">
      <section class="flex items-center gap-2 my-4">
        ...
        dark:border-gray-700 file:text-gray-700 file:dark:text-gray-400
        file:border-0 file:bg-gray-100 file:dark:bg-gray-800 file:font-medium
        file:hover:bg-gray-200 file:dark:hover:bg-gray-700 file:hover:cursor-pointer mr-4"
  ...
  <Box v-if="listing.images.length" class="mt-4">
    ...
    <section class="mt-4 grid grid-cols-3 gap-4">
      <div v-for="image in listing.images" :key="image.id" class="flex flex-col justify-between">
        <img :src="image.src" class="rounded-md w-full h-full" />
