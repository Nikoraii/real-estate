<template>
  <form @submit.prevent="update">
    <div class="grid grid-cols-6 gap-4">
      ...
      <div class="col-span-2">
        <label class="layer">Post Code</label>
      ...
      <div class="col-span-4">
        <label class="layer">Street</label>
      ...
      <div class="col-span-2">
        <label class="layer">Street Nr</label>
      ...
      <div class="col-span-6">
        <label class="layer">Price</label>
        <input v-model.number="form.price" type="integer" class="input" />
